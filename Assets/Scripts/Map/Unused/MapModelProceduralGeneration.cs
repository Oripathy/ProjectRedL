...
{
    public class MapModelProceduralGeneration : IInitializable, IDisposable
    {
        ...
        public MapModelProceduralGeneration(MapConfigurations configurations, IFactory<Indices, MapCellModel> cellFactory,
