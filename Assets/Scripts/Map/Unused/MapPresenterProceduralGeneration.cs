...
{
    public class MapPresenterProceduralGeneration : Presenter<MapView>, IMap
    {
        private readonly IFactory<MapCellView> _factory;
        private readonly MapModel _model;
        private readonly Dictionary<Indices, MapCellView> _cellViewsMap;

        public MapPresenterProceduralGeneration(MapModel model, IFactory<MapCellView> factory)
        {
            _model = model;
            _factory = factory;
